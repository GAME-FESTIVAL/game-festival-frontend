...
const MAIN_QUERY_KEYS = createQueryKeyFactory(mainApis, 'main')

export const useGetPopularGameList = () => {
  return useQuery({
    queryKey: MAIN_QUERY_KEYS.getPopularGameList, // ['main', 'list', 'getPopularGameList']
...
export const useGetHotdealGameList = () => {
  return useQuery({
    queryKey: MAIN_QUERY_KEYS.getHotdealGameList,
...
export const useGeNewGameList = () => {
  return useQuery({
    queryKey: MAIN_QUERY_KEYS.getNewGameList,
...
export const useGetBestGameList = () => {
  return useQuery({
    queryKey: MAIN_QUERY_KEYS.getBestGameList,
...
export const useGetUpcomingGameList = () => {
  return useQuery({
    queryKey: MAIN_QUERY_KEYS.getUpcomingGameList,
...
export const useGetSpecialDiscountGameList = () => {
  return useQuery({
    queryKey: MAIN_QUERY_KEYS.getSpecialDiscountGameList,
...
export const useGetPopularFreeGameList = () => {
  return useQuery({
    queryKey: MAIN_QUERY_KEYS.getPopularFreeGameList,
...
export const useGetGameDetail = (id: string) => {
  return useQuery({
    queryKey: [...MAIN_QUERY_KEYS.getGameDetail, id], // ['main', 'detail', 'getGameDetail', id]
    queryFn: () => mainApis.detail.getGameDetail(id),
    enabled: !!id,
  })
}

export default MAIN_QUERY_KEYS
